...
module.exports.controllerFunction = function(app) {
    ...
    userRouter.post('/login',function(req,res){
      ...
      //Api forgot password 
   /* userRouter.post('/:password',function(req,res){

        userModel.findOne({$and:[{'email':req.body.email},{'mobileNumber':req.body.mobileNumber}]},function(err,foundUser){
            if(err){
                var myResponse = responseGenerator.generate(true,"some error"+err,500,null);
                res.send(myResponse);
            }
                ...
                var myResponse = responseGenerator.generate(true,"user not found. Check your email and mobileNumber",404,null);
                //res.send(myResponse);
                res.render('error', {
                  message: myResponse.message,
                  error: myResponse.data
